...
- [ ] Framework (`.kenovis/AI/`, `CLAUDE.md`, `README.md`, `cli/README.md`)
...
- [ ] Stays tool-agnostic under `.kenovis/AI/` (no Claude-Code-specific syntax outside `CLAUDE.md`) — see [DECISION-010](../company-os/DECISIONS.md)
