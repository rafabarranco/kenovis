...
**OF-23 should be taken before or alongside round 3.** It is the cheapest thing on the board, the archive pass has a written procedure that has been run twice, and this document keeps growing every round while its own guard is structurally unable to say so. Five rounds of item-37 narrative have gone into it since the last pass.
