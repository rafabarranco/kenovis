...
43. SCHEDULED (founder-flagged **maximum priority**, 2026-08-15 — ranked ahead of item 40 part 3 and everything else on this board) — `.kenovis/` in this repository is committed, hand-edited source; it should be generated build output, the same as it is in every customer Installation.
