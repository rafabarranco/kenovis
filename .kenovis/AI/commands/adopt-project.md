...
Before touching `conventions.md` and `learnings.md`, run the same Review Process `init-project.md` Step 8 requires: promote any Critical/Important, reusable learning to `.kenovis/AI/policies/` or the Framework Terms section of `conventions.md` before deleting it.
