...
Then verify mechanically, using `.kenovis/AI/policies/code-quality.md` as the checklist — do not rely on impression alone. Confirm the author actually ran the project's real lint/type-check/test commands (`.kenovis/AI/policies/coding.md` → "Definition of Done"), not just that the code looks clean.
...
Walk the change against `.kenovis/AI/policies/code-quality.md` Categories 3 (Security Vulnerabilities) and 4 (Security Hotspots) — do not rely on impression alone for injection, crypto, and secrets handling.
...
- Tenant isolation.
- Migration safety.
- Data integrity — walk against `.kenovis/AI/policies/code-quality.md` Category 10 (Concurrency & Data Integrity): uniqueness and atomicity enforced by the database, not only by application code.
...
- Accessibility — walk against `.kenovis/AI/policies/code-quality.md` Category 7.
- State management.
- UX consistency.
- Performance.
...
- Domain correctness.
- API consistency — walk against `.kenovis/AI/policies/code-quality.md` Category 9.
- Error handling.
- Authorization.
- Transactions — walk against `.kenovis/AI/policies/code-quality.md` Category 10.
- Logging — walk against `.kenovis/AI/policies/code-quality.md` Category 12.
...
✓ Change was walked against `.kenovis/AI/policies/code-quality.md`.
